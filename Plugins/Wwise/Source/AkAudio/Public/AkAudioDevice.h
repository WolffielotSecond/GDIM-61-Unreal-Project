...
private:
	...
	*/
	...
	void AddEditorListenerToEditorWorld(UWorld* World);
	...
	*/
	...
	bool FindWwiseLanguage(const FString& NewAudioCulture, FString& FoundWwiseLanguage, bool bUseDefaultLanguageIfNotFound = true);
