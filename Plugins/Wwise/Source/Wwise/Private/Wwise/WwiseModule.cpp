...
#if UE_5_8_OR_LATER
			OnPostEngineInitHandle = FCoreDelegates::GetOnPostEngineInit().AddRaw(this, &FWwiseModule::OnPostEngineInit);
#else
			OnPostEngineInitHandle = FCoreDelegates::OnPostEngineInit.AddRaw(this, &FWwiseModule::OnPostEngineInit);
#endif
		}
