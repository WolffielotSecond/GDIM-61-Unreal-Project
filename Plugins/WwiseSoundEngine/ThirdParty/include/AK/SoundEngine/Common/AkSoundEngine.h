...
namespace AK
{
	...
	namespace SoundEngine
	{
		...
		AK_EXTERNAPIFUNC(void, ProcessBanks)();
		...
		/// \endaknote
		/// \return Always returns AK_Success
		AK_EXTERNAPIFUNC( AKRESULT, SetContainerEffect)(
		...
		/// \remarks The captured audio in the buffer is interleaved. Use <tt>AkAudioBuffer::GetInterleavedData</tt> to access it. Avoid using functions from the de-interleaved interface such as <tt>AkAudioBuffer::GetChannel</tt>.
		/// \return
		/// - \c AK_Success when successful
