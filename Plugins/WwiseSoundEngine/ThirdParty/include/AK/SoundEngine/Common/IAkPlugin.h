...
namespace AK
{
	...
	public:
		...
		/// Retrieve the number of emitter-listener pairs (Sound Paths) of the game object.
		...
		/// Sound Paths whose listeners are irrelevant to the current context are ignored. For example,
	...
	public:
		...
		/// 3D spatialization:
		/// Retrieve the number of emitter-listener pairs (Sound Paths) of this input.
		...
		/// Returned Sound Paths are those that result from engine automation, if applicable.
