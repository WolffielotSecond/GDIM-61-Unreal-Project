 ...
 * \file AK/Wwise/Plugin/V1/HostPropertySet.h
 */
...
#endif
{
	...
	ak_wwise_plugin_host_property_set_v1(int version = 1) :
		ak_wwise_plugin_base_interface(AK_WWISE_PLUGIN_INTERFACE_TYPE_HOST_PROPERTY_SET, version)
	{}
#endif
...
namespace AK::Wwise::Plugin
{
	namespace V1
	{
		...
		template<typename CHostPropertySetT = CHostPropertySet, int interface_version = 1>
		class PropertySetBase : public CBaseInstanceGlue<CHostPropertySetT>
		{
		public:
			 ...
			 * 		This is a semi-private function. You should use the typed GetValue methods instead.
			 * 
			 * 		\ref AK::Wwise::Plugin::V1::PropertySetBase::GetValueString, \ref AK::Wwise::Plugin::V1::PropertySetBase::GetValueInt64, \ref AK::Wwise::Plugin::V1::PropertySetBase::GetValueInt32, \ref AK::Wwise::Plugin::V1::PropertySetBase::GetValueInt16,
			 *   	\ref AK::Wwise::Plugin::V1::PropertySetBase::GetValueInt8, \ref AK::Wwise::Plugin::V1::PropertySetBase::GetValueUInt64, \ref AK::Wwise::Plugin::V1::PropertySetBase::GetValueUInt32, \ref AK::Wwise::Plugin::V1::PropertySetBase::GetValueUInt16,
			 *  	\ref AK::Wwise::Plugin::V1::PropertySetBase::GetValueUInt8, \ref AK::Wwise::Plugin::V1::PropertySetBase::GetValueReal64 \ref AK::Wwise::Plugin::V1::PropertySetBase::GetValueReal32, \ref AK::Wwise::Plugin::V1::PropertySetBase::GetValueBool
			 * 
			 * 		The function can still be useful if you want to handle parameters as a black box, getting a
			 * 		value without knowing the type, and then setting that value elsewhere.
			 * \endakwarning
			...
			{
				return MKBOOL(this->g_cinterface->GetValue(this, &in_guidPlatform, in_pszPropertyName, &out_varProperty));
			}
			 ...
			 * \aknote
			 * 		Your changes might be substantially altered or replaced if your property is bound to an RTPC
			 * 		( \ref AK::Wwise::Plugin::V1::PropertySetBase::PropertyHasRTPC ) or a State ( \ref AK::Wwise::Plugin::V1::PropertySetBase::PropertyHasState ).
			 * 
			 * 		More than one platform will be affected if the property is linked
			 * 		( \ref AK::Wwise::Plugin::V1::PropertySetBase::PropertyPlatformIsLinked ); all platforms are linked by default.
			 * \endaknote
			 * 
			 * \akwarning
			 * 		This is a semi-private function. You should use the typed SetValue methods instead.
			 *
			 * 		\ref AK::Wwise::Plugin::V1::PropertySetBase::SetValueString, \ref AK::Wwise::Plugin::V1::PropertySetBase::SetValueInt64, \ref AK::Wwise::Plugin::V1::PropertySetBase::SetValueInt32, \ref AK::Wwise::Plugin::V1::PropertySetBase::SetValueInt16,
			 *   	\ref AK::Wwise::Plugin::V1::PropertySetBase::SetValueInt8, \ref AK::Wwise::Plugin::V1::PropertySetBase::SetValueUInt64, \ref AK::Wwise::Plugin::V1::PropertySetBase::SetValueUInt32, \ref AK::Wwise::Plugin::V1::PropertySetBase::SetValueUInt16,
			 *  	\ref AK::Wwise::Plugin::V1::PropertySetBase::SetValueUInt8, \ref AK::Wwise::Plugin::V1::PropertySetBase::SetValueReal64 \ref AK::Wwise::Plugin::V1::PropertySetBase::SetValueReal32, \ref AK::Wwise::Plugin::V1::PropertySetBase::SetValueBool
			 * 
			 * 		The function can still be useful if you want to handle parameters as a black box, getting a
			 * 		value without knowing the type, and then setting that value elsewhere.
			 * \endakwarning
			...
			{
				return MKBOOL(this->g_cinterface->SetValue(this, &in_guidPlatform, in_pszPropertyName, &in_varProperty));
			}
			...
			{
				return MKBOOL(this->g_cinterface->HasPropertyValue(this, &in_guidPlatform, in_pszPropertyName));
			}
			...
			{
				return MKBOOL(this->g_cinterface->PropertyHasRTPC(this, in_pszPropertyName));
			}
			...
			{
				return MKBOOL(this->g_cinterface->PropertyHasState(this, in_pszPropertyName));
			}
			...
			{
				return MKBOOL(this->g_cinterface->PropertyHasLinked(this, in_pszPropertyName));
			}
			...
			{
				return MKBOOL(this->g_cinterface->PropertyHasUnlinked(this, in_pszPropertyName));
			}
			...
			{
				return MKBOOL(this->g_cinterface->PropertyPlatformIsLinked(this, &in_guidPlatform, in_pszPropertyName));
			}
			...
			{
				return this->g_cinterface->GetID(this);
			}
			...
			{
				return this->g_cinterface->GetType(this, &in_guidPlatform, in_pszPropertyName);
			}
			...
			{
				return MKBOOL(this->g_cinterface->ClearValue(this, &in_guidPlatform, in_pszPropertyName));
			}
			...
			{
				return MKBOOL(this->g_cinterface->SetValueString(this, &in_guidPlatform, in_pszPropertyName, in_propertyValue));
			}
			...
			{
				return MKBOOL(this->g_cinterface->SetValueInt64(this, &in_guidPlatform, in_pszPropertyName, in_propertyValue));
			}
			...
			{
				return MKBOOL(this->g_cinterface->SetValueInt32(this, &in_guidPlatform, in_pszPropertyName, in_propertyValue));
			}
			...
			{
				return MKBOOL(this->g_cinterface->SetValueInt16(this, &in_guidPlatform, in_pszPropertyName, in_propertyValue));
			}
			...
			{
				return MKBOOL(this->g_cinterface->SetValueInt8(this, &in_guidPlatform, in_pszPropertyName, in_propertyValue));
			}
			...
			{
				return MKBOOL(this->g_cinterface->SetValueUInt64(this, &in_guidPlatform, in_pszPropertyName, in_propertyValue));
			}
			...
			{
				return MKBOOL(this->g_cinterface->SetValueUInt32(this, &in_guidPlatform, in_pszPropertyName, in_propertyValue));
			}
			...
			{
				return MKBOOL(this->g_cinterface->SetValueUInt16(this, &in_guidPlatform, in_pszPropertyName, in_propertyValue));
			}
			...
			{
				return MKBOOL(this->g_cinterface->SetValueUInt8(this, &in_guidPlatform, in_pszPropertyName, in_propertyValue));
			}
			...
			{
				return MKBOOL(this->g_cinterface->SetValueReal64(this, &in_guidPlatform, in_pszPropertyName, in_propertyValue));
			}
			...
			{
				return MKBOOL(this->g_cinterface->SetValueReal32(this, &in_guidPlatform, in_pszPropertyName, in_propertyValue));
			}
			...
			{
				return MKBOOL(this->g_cinterface->SetValueBool(this, &in_guidPlatform, in_pszPropertyName, in_propertyValue));
			}
			...
			{
				return MKBOOL(this->g_cinterface->GetValueString(this, &in_guidPlatform, in_pszPropertyName, &out_propertyValue));
			}
			...
			{
				return MKBOOL(this->g_cinterface->GetValueInt64(this, &in_guidPlatform, in_pszPropertyName, &out_propertyValue));
			}
			...
			{
				return MKBOOL(this->g_cinterface->GetValueInt32(this, &in_guidPlatform, in_pszPropertyName, &out_propertyValue));
			}
			...
			{
				return MKBOOL(this->g_cinterface->GetValueInt16(this, &in_guidPlatform, in_pszPropertyName, &out_propertyValue));
			}
			...
			{
				return MKBOOL(this->g_cinterface->GetValueInt8(this, &in_guidPlatform, in_pszPropertyName, &out_propertyValue));
			}
			...
			{
				return MKBOOL(this->g_cinterface->GetValueUInt64(this, &in_guidPlatform, in_pszPropertyName, &out_propertyValue));
			}
			...
			{
				return MKBOOL(this->g_cinterface->GetValueUInt32(this, &in_guidPlatform, in_pszPropertyName, &out_propertyValue));
			}
			...
			{
				return MKBOOL(this->g_cinterface->GetValueUInt16(this, &in_guidPlatform, in_pszPropertyName, &out_propertyValue));
			}
			...
			{
				return MKBOOL(this->g_cinterface->GetValueUInt8(this, &in_guidPlatform, in_pszPropertyName, &out_propertyValue));
			}
			...
			{
				return MKBOOL(this->g_cinterface->GetValueReal64(this, &in_guidPlatform, in_pszPropertyName, &out_propertyValue));
			}
			...
			{
				return MKBOOL(this->g_cinterface->GetValueReal32(this, &in_guidPlatform, in_pszPropertyName, &out_propertyValue));
			}
			...
			{
				return MKBOOL(this->g_cinterface->GetValueBool(this, &in_guidPlatform, in_pszPropertyName, &out_propertyValue));
			}

			/**
			 * \brief Retrieves the string value of a specific property and returns the value as a temporary pointer.
			 * 
			 * This is a convenience for \ref AK::Wwise::Plugin::V1::PropertySetBase::GetValueString where the value is returned instead of
			 ...
			 * 
			 * This is a convenience for \ref AK::Wwise::Plugin::V1::PropertySetBase::GetValueInt64 where the value is returned instead of
			 * being set in a provided variable.
			 * 
			 * The plug-in XML definition file should define this property as a \c int64 in order to use
			 * this method.
			 ...
			 * 
			 * This is a convenience for \ref AK::Wwise::Plugin::V1::PropertySetBase::GetValueInt32 where the value is returned instead of
			 * being set in a provided variable.
			 * 
			 * The plug-in XML definition file should define this property as a \c int32 in order to use
			 * this method.
			 ...
			 * 
			 * This is a convenience for \ref AK::Wwise::Plugin::V1::PropertySetBase::GetValueInt16 where the value is returned instead of
			 * being set in a provided variable.
			 * 
			 * The plug-in XML definition file should define this property as a \c int16 in order to use
			 * this method.
			 ...
			 * 
			 * This is a convenience for \ref AK::Wwise::Plugin::V1::PropertySetBase::GetValueInt8 where the value is returned instead of
			 * being set in a provided variable.
			 * 
			 * \akwarning
			 * 		The plug-in XML definition file doesn't currently provide a \c int8 value type.
			 ...
			 * 
			 * This is a convenience for \ref AK::Wwise::Plugin::V1::PropertySetBase::GetValueUInt64 where the value is returned instead of
			 * being set in a provided variable.
			 * 
			 * \akwarning
			 * 		The plug-in XML definition file doesn't currently provide a \c uint64 value type.
			 ...
			 * 
			 * This is a convenience for \ref AK::Wwise::Plugin::V1::PropertySetBase::GetValueUInt32 where the value is returned instead of
			 * being set in a provided variable.
			 * 
			 * \akwarning
			 * 		The plug-in XML definition file doesn't currently provide a \c uint32 value type.
			 ...
			 * 
			 * This is a convenience for \ref AK::Wwise::Plugin::V1::PropertySetBase::GetValueUInt16 where the value is returned instead of
			 * being set in a provided variable.
			 * 
			 * \akwarning
			 * 		The plug-in XML definition file doesn't currently provide a \c uint16 value type.
			 ...
			 * 
			 * This is a convenience for \ref AK::Wwise::Plugin::V1::PropertySetBase::GetValueUInt8 where the value is returned instead of
			 * being set in a provided variable.
			 * 
			 * \akwarning
			 * 		The plug-in XML definition file doesn't currently provide a \c uint8 value type.
			 ...
			 * 
			 * This is a convenience for \ref AK::Wwise::Plugin::V1::PropertySetBase::GetValueReal64 where the value is returned instead of
			 * being set in a provided variable.
			 * 
			 * The plug-in XML definition file should define this property as a \c Real64 in order to use
			 * this method.
			 ...
			 * 
			 * This is a convenience for \ref AK::Wwise::Plugin::V1::PropertySetBase::GetValueReal32 where the value is returned instead of
			 * being set in a provided variable.
			 * 
			 * The plug-in XML definition file should define this property as a \c Real32 in order to use
			 * this method.
			 ...
			 * 
			 * This is a convenience for \ref AK::Wwise::Plugin::V1::PropertySetBase::GetValueBool where the value is returned instead of
			 * being set in a provided variable.
			 * 
			 * The plug-in XML definition file should define this property as a \c bool in order to use
			 * this method.
		...
		using PropertySet = PropertySetBase<>;
		...
		namespace Notifications
		{
			...
			public:
				/**
				 * \copydoc ak_wwise_plugin_notifications_property_set_v1::Instance
				 */
	...
	AK_WWISE_PLUGIN_SPECIALIZE_HOST_INTERFACE(V1::PropertySet, propertySet,, public Notifications::PropertySet);
	AK_WWISE_PLUGIN_SPECIALIZE_INTERFACE_CLASS(V1::PropertySet);
